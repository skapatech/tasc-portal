...
describe ProvidersController do
  ...
  #       post :create, {:provider => { "first_name" => "invalid value" }}, valid_session
  #       assigns(:provider).should be_a_new(Provider)
  #     end
  #
  ...
  #       Provider.any_instance.should_receive(:update).with({ "first_name" => "MyString" })
  #       put :update, {:id => provider.to_param, :provider => { "first_name" => "MyString" }}, valid_session
  #     end
  #
  #     it "assigns the requested provider as @provider" do
  #       provider = Provider.create! valid_attributes
  ...
  #       # Trigger the behavior that occurs when invalid params are submitted
  #       Provider.any_instance.stub(:save).and_return(false)
  #       put :update, {:id => provider.to_param, :provider => { "first_name" => "invalid value" }}, valid_session
  #       assigns(:provider).should eq(provider)
  #     end
  #
